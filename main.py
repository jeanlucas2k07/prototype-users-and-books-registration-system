...
from gui.ParâmetrosJanelas import WindowParams
from gui.LimparJanelas import LimparJanelas
from utils.p import LivroFrame
from auth.sessao import Sessao
from gui.buttonFunctions import ButtonFunctions


os.environ["CTK_FORCE_WINDOWS"] = "1"  # Isso pode melhorar a aparência no Linux
id_users = []
...
class App(CTk, WindowParams, LimparJanelas):
    ...
    def __init__(self):
        os.environ["CTK_DISABLE_MACOS_DARKMODE"] = "1"
        super().__init__()
        self.janela_config()
        self.janela_login()
    ...
    def janela_login(self):
        ...
        self.img_logo = os.path.join(os.path.dirname(__file__), r'assets/images/img_logo.png')
        ...
        self.image = os.path.join(os.path.dirname(__file__), r'assets/images/img_login.png')
    ...
    def janela_principal(self):
        ...
        self.bestsellers = LivroFrame(parent=self, id=Sessao().return_id())
        ...
        usuario_image = os.path.join(os.path.dirname(__file__), r'assets/images/img_usuário.png')
        ...
        config_image = os.path.join(os.path.dirname(__file__), r'assets/images/img_config.png')
        ...
        pesquisa_image = os.path.join(os.path.dirname(__file__), r'assets/images/img_pesquisa.png')
        ...
        img_banner = os.path.join(os.path.dirname(__file__),
                                  r'assets/images/img_bannerbom.jpg')
    ...
    def pesquisa_detalhada(self):
        ...
        image_voltar = os.path.join(os.path.dirname(__file__), r'assets/images/img_voltar.png')
        ...
        self.image = os.path.join(os.path.dirname(__file__),
                                  r'assets/images/pesquia_image 2.png')
    ...
    def config(self):
        ...
        image_voltar = os.path.join(os.path.dirname(__file__),
                                    r'assets/images/img_voltar.png')
        image_voltar = CTkImage(light_image=Image.open(image_voltar), size=(40, 40))
    ...
    def janela_cadastro_livro(self):
        ...
        self.imagem = os.path.join(os.path.dirname(__file__),
                                   r'assets/images/img_biblioteca.png')
    ...
    def janela_empréstimo(self):
        ...
        img_banner = os.path.join(os.path.dirname(__file__), r'assets/images/img_bannerbom.jpg')
        img_banner = CTkImage(light_image=Image.open(img_banner), size=(330, 96))
        img_banner = CTkLabel(master=self.frame_livro, text="", image=img_banner)
        img_banner.place(relx=0.5, rely=0.18, anchor=CENTER)
        ...
        self.imagem = os.path.join(os.path.dirname(__file__), r'assets/images/img_biblioteca.png')
        self.imagem = CTkImage(light_image=Image.open(self.imagem), size=(591, 422))
        self.imagem = CTkLabel(self, text='', image=self.imagem, )
        self.imagem.place(relx=0.6, rely=0.5, anchor=E)
